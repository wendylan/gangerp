	...
	<style type="text/css">
		...
		* {
		...
		.input_style {
			...
			margin-top: 5px;
			padding-left: 5px;
		  	-webkit-box-shadow: 40px 40px 40px 40px #61c1cf inset !important;
		  	box-shadow: 40px 40px 40px 40px #61c1cf inset !important;
		}
		.input_style:-webkit-autofill:focus,.input_style:-webkit-autofill {
			color:#fff !important;
		}
		.password_forget {
		    margin-top: 20px;
				...
				<div class="right_vertial">
					<form  method="POST" action="login" >
						...
						<div class="right_main">
                            ...
                            @endif
							<!-- {{ $errors->has('email')}} -->
							<h3 style="margin-top: 10px;">密码:</h3>
