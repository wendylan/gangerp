<html lang="en">
  <head>
    ...
    <style>
        *{
        ...
        .right_vertial .el-tabs__item:hover{
            color: #fff;
        }
        .right_vertial .el-form-item__label{
            color: #fff;
        }
    </style>
  </head> 
  <body>
    ...
    <script src="./data/dist/register.js"></script>
  </body>
</html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <!-- <script src="data/assets/js/jquery.table2excel.min.js"></script> -->
    <script src="./data/dist/vendor.js"></script>
    <script src="./data/dist/forgetPassword.js"></script>
  </body>
</html>
